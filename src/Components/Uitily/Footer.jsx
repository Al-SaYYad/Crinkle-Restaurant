          ...
          <Col sm="12" className="footer-foot">
            ...
            <div className="links-icons">
              <div className="icon-container">
                <a
                  target="_blank"
                  href="https://www.facebook.com/CrinkleEgypt/"
                >
                  <svg
              ...
              <div className="icon-container">
                <a
                  target="_blank"
                  href="https://www.instagram.com/Crinkle.Egypt/"
                >
                  <svg
              ...
              <div className="icon-container">
                <a target="_blank" href="https://www.tiktok.com/@crinkleegypt/">
                  <svg
              ...
              <div className="icon-container">
                <a target="_blank" href="https://x.com/crinkleegypt/">
                  <svg
